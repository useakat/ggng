C   18/10/90 109050545  MEMBER NAME  USERIN   (S)        M  FORTRAN
 ...
 9200 format(1x,'!',f10.1,' !',2(g14.6,' !'),g14.3,' !',i4,' !',
     &           i4,' !')
      ...
      write(lustdo,'()')
      write(lustdo,'(5x,a)') '=================================='
      write(lustdo,'(5x,a)') '  u u~ --> 3g (Input Parameters)'
      write(lustdo,'(5x,a)') '=================================='
      write(lustdo,'()')
...
c     &     ', ',nhtot
      ...
      write(lustdo,'()')
      write(lustdo,'(5x,a)') '=================================='
      write(lustdo,'(5x,a)') '  u u~ --> 3g (Bases Parameters)'
      write(lustdo,'(5x,a)') '=================================='
      write(lustdo,'()')
      ...
      write(lustdo,'()')
      write(lustdo,'(5x,a)') '================================='
      write(lustdo,'(5x,a)') '  u u~ --> 3g (Kinematic Cuts)'
      write(lustdo,'(5x,a)') '================================='
      write(lustdo,'()')
...
c      write(lustdo,'(9x,a,f8.1)') 'Delta_R = ',drcut
      write(lustdo,'()')
      write(lustdo,'(5x,a)') '==============================='
      write(lustdo,'(5x,a)') '  u u~ --> 3g (PS variables)'
      write(lustdo,'(5x,a)') '==============================='
      write(lustdo,'()')
