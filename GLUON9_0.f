      ...
      double complex w6(6),w7(6),w8(6),w9(6)
...
C 4-point
         CALL GGGGCF(W(1,I,I+5),W(1,I+6,I+6),W(1,I+7,I+7),W(1,I+8,I+8),
     &        G,Z( 8))     
         CALL GGGGCF(W(1,I,I+4),W(1,I+5,I+6),W(1,I+7,I+7),W(1,I+8,I+8),
     &        G,Z( 9))     
         CALL GGGGCF(W(1,I,I+3),W(1,I+4,I+6),W(1,I+7,I+7),W(1,I+8,I+8),
     &        G,Z(10))     
         CALL GGGGCF(W(1,I,I+2),W(1,I+3,I+6),W(1,I+7,I+7),W(1,I+8,I+8),
     &        G,Z(11))     
         CALL GGGGCF(W(1,I,I+1),W(1,I+2,I+6),W(1,I+7,I+7),W(1,I+8,I+8),
     &        G,Z(12))     
         CALL GGGGCF(W(1,I,I  ),W(1,I+1,I+6),W(1,I+7,I+7),W(1,I+8,I+8),
     &        G,Z(13))     
         CALL GGGGCF(W(1,I,I+4),W(1,I+5,I+5),W(1,I+6,I+7),W(1,I+8,I+8),
     &        G,Z(14))     
         CALL GGGGCF(W(1,I,I+3),W(1,I+4,I+5),W(1,I+6,I+7),W(1,I+8,I+8),
     &        G,Z(15))     
         CALL GGGGCF(W(1,I,I+2),W(1,I+3,I+5),W(1,I+6,I+7),W(1,I+8,I+8),
     &        G,Z(16))     
         CALL GGGGCF(W(1,I,I+1),W(1,I+2,I+5),W(1,I+6,I+7),W(1,I+8,I+8),
     &        G,Z(17))     
         CALL GGGGCF(W(1,I,I  ),W(1,I+1,I+5),W(1,I+6,I+7),W(1,I+8,I+8),
     &        G,Z(18))     
         CALL GGGGCF(W(1,I,I+3),W(1,I+4,I+4),W(1,I+5,I+7),W(1,I+8,I+8),
     &        G,Z(19))     
         CALL GGGGCF(W(1,I,I+2),W(1,I+3,I+4),W(1,I+5,I+7),W(1,I+8,I+8),
     &        G,Z(20))     
         CALL GGGGCF(W(1,I,I+1),W(1,I+2,I+4),W(1,I+5,I+7),W(1,I+8,I+8),
     &        G,Z(21))     
         CALL GGGGCF(W(1,I,I)  ,W(1,I+1,I+4),W(1,I+5,I+7),W(1,I+8,I+8),
     &        G,Z(22))     
         CALL GGGGCF(W(1,I,I+2),W(1,I+3,I+3),W(1,I+4,I+7),W(1,I+8,I+8),
     &        G,Z(23))     
         CALL GGGGCF(W(1,I,I+1),W(1,I+2,I+3),W(1,I+4,I+7),W(1,I+8,I+8),
     &        G,Z(24))     
         CALL GGGGCF(W(1,I,I)  ,W(1,I+1,I+3),W(1,I+4,I+7),W(1,I+8,I+8),
     &        G,Z(25))     
         CALL GGGGCF(W(1,I,I+1),W(1,I+2,I+2),W(1,I+3,I+7),W(1,I+8,I+8),
     &        G,Z(26))     
         CALL GGGGCF(W(1,I,I)  ,W(1,I+1,I+2),W(1,I+3,I+7),W(1,I+8,I+8),
     &        G,Z(27))     
         CALL GGGGCF(W(1,I,I)  ,W(1,I+1,I+1),W(1,I+2,I+7),W(1,I+8,I+8),
     &        G,Z(28))     
         DO K=1,28
            vertex=vertex+Z(K)
         ENDDO  
